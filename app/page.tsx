...
export default function Page() {
  const links = [
    {
      ...
      label: "@Eco CHIC",
      href: "https://www.instagram.com/eco.shic/",
    },
    // {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 md:p-8">
      ...
      {/* Main Content Card */}
      <div className="relative z-10 w-full max-w-2xl mx-auto bg-[#37510f]/95 backdrop-blur-sm rounded-3xl overflow-hidden shadow-2xl shadow-white/10">
        <div className="relative w-full h-64">
          <Image
            src="/images/design-mode/cover-image.png"
            alt="ECO CHIC Storefront"
            fill
            className="object-cover"
            priority
          />
        ...
        <div className="relative -mt-16 flex justify-center mb-4">
          <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-xl shadow-white/30 ">
            <Image
              src="/images/design-mode/eco-chic-logo.png"
              alt="ECO CHIC Logo"
              width={128}
              height={128}
        ...
        <div className="text-center px-6 mb-8 space-y-4">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-white">ECO CHIC</h1>
          <p className="text-lg text-white/80 italic">Cosmetiques Store Bio</p>
        ...
        <div className="space-y-4 px-6 mb-8">
          {links.map((link, index) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group block w-full px-6 py-4 border-2 border-white rounded-full bg-[#37510f] hover:bg-white hover:text-[#1e3a8a] transition-all duration-300 shadow-lg shadow-white/10 hover:shadow-white/30"
            >
        ...
        <div className="px-6 mb-8">
          <a
            href="https://maps.app.goo.gl/BmeU53VmvvPyj9FT6"
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3236.66300844936!2d-5.815380324159544!3d35.78365347255435!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd0c7fd2346a92f9%3A0x1c8bb749b8d8aae3!2sEco%20Chic!5e0!3m2!1sfr!2sma!4v1776421192538!5m2!1sfr!2sma"
              width="100%"
              height="300"
          ...
          >
            ...
            <span className="text-sm">Eco Chic, Rue de la Liberté, Tanger</span>
          </a>
        </div>

        {/* Footer */}
        <footer className="text-center text-sm text-white/60 px-6 pb-8">
          <p>© 2025 ECO CHIC – Tous droits réservés</p>
        </footer>
      </div>
    </div>
  )
